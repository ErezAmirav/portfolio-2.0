      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            ...
            specialization. <br />
            Skills: JavaScript, TypeScript, HTML, CSS, Java, C, C++.
            <br />
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-600 to-cyan-500 hover:bg-slate-400 text-white">
              Hire Me
            </button>
